...
TOKEN = '7675949271:AAEMWZuP2EiPcfX7eAQrPSm4ablN9KBxqPE'
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*🚫 YOU ARE NOT APPROVED 🚫\n\nOops! It seems like you don't have permission to use the Attack command. To gain access and unleash the power of attacks, you can:\n👉 Contact an Admin or the Owner for approval @VirtualVenture*", parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "Buy Access! 💰":
        bot.reply_to(message, "* 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦 𝗣𝗥𝗜𝗖𝗘\n\n[𝗣𝗿𝗲𝗺𝗶𝘂𝗺]\n> DAY - 150 INR\n> WEEK - 700 INR\n\n[𝗣𝗹𝗮𝘁𝗶𝗻𝘂𝗺]\n> MONTH - 1600 INR\n\nDM TO BUY @VirtualVenture *", parse_mode='Markdown')
        ...
        if user_data:
            ...
            response = "*No account information found. Please contact the administrator @VirtualVenture *"
